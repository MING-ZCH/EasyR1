...
CEPH="/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz"
SOURCE_RUN="StepCount-7B_v35_dense_11_20_A_emalign_20260701_0432"
...
export V32_LOAD_CHECKPOINT_PATH=${V32_LOAD_CHECKPOINT_PATH:-${CEPH}/checkpoints/${SOURCE_RUN}/global_step_${V35_RESUME_STEP}}
...
export V31_SAVE_CHECKPOINT_PATH=${V31_SAVE_CHECKPOINT_PATH:-${CEPH}/checkpoints/${V31_EXPERIMENT_NAME}}
