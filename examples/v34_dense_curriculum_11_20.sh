...
SFT_BASE="${CEPH}/models/StepCount-7b-SFT-30k-high-without-reasoning"
...
export STEPCOUNT_TRAIN_DATA=${STEPCOUNT_TRAIN_DATA:-${CEPH}/datasets/StepCountQA-RL-Traj_11_20_plus_replay}
