...
# V15_RESUME_CKPT="${V15_RESUME_CKPT:-/data/workspace/hyleochang/EasyR1-latest/save/StepCount-7B-SFT-30k_v11_mask_reward_v4bok_grpo_hm0_gateoff_bok_grpo_20260313_1852/global_step_66}"
...
export STEPCOUNT_MASKS_METADATA=${STEPCOUNT_MASKS_METADATA:-/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/sam_mask/StepCount-RL_masks_output/masks_metadata.json}
export STEPCOUNT_MASKS_DIR=${STEPCOUNT_MASKS_DIR:-/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/sam_mask/StepCount-RL_masks_output/masks}
...
MODEL_PATH=/data/workspace/hyleochang/EasyR1-latest/save/StepCount-7B-SFT-30k_v12_mask_reward_v4bok_grpo_hm0_gateoff_bok_grpo_20260315_0136/global_step_178/actor/huggingface
...
for required_path in \
    "${MODEL_PATH}" \
    "/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/StepCountQA-RL-Traj_0_10_mixed_hard_easy" \
    "/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/stepcount-500" \
...
python3 -m verl.trainer.main \
    ...
    data.train_files=/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/StepCountQA-RL-Traj_11_50 \
    data.system_prompt_file=${SYSTEM_PROMPT_FILE} \
    data.format_prompt=null \
    data.val_files=/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/datasets/stepcount-500 \
    ...
    trainer.save_checkpoint_path=/data/workspace/hyleochang/EasyR1-latest/save/StepCount-7B-SFT-30k_trajectory_11_50_v3_mask_reward_v4${STEPCOUNT_RL_MODE}_hm${INTERLEAVED_HISTORY_MODE}_gate${TRAJ_ANSWER_GATE_MODE}_${ADV_ESTIMATOR}_$(date +%Y%m%d_%H%M) \
