...
MODEL_PATH=//apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/models/Qwen2.5-VL-7B-Instruct
...
python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path=/data/workspace/hyleochang/EasyR1-latest/save/qwenbase_v7_${STEPCOUNT_RL_MODE}_hm${INTERLEAVED_HISTORY_MODE}_gate${TRAJ_ANSWER_GATE_MODE}_${ADV_ESTIMATOR}_$(date +%Y%m%d_%H%M) \
