...
python3 -m verl.trainer.main \
    ...
    data.train_files=/weiyang/250010212/data/StepCountQA-Selected@train \
    data.val_files=/weiyang/250010212/data/StepCountQA-Selected@test \
    ...
    trainer.experiment_name=qwen2_5_vl_7b_StepCount_selected_grpo_shuffle_$(date +%Y%m%d_%H%M) \
    trainer.logger=['console','wandb'] \
    trainer.n_gpus_per_node=8 2>&1 | tee "${LOG_DIR}/training_selected_shuffle_$(date +%Y%m%d_%H%M%S).log"