...
NNODES="${2:?nnodes}"
BATCH="${3:?batch}"
MODEL_PATH_ARG="${4:-/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/models/StepCount-7B-SFT-1M}"
BASETAG="${5:-1M_v35}"
TS=$(date +%Y%m%d_%H%M)
LOGDIR=/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/logs/rl
...
export WANDB_API_KEY=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
export WANDB_DIR=/apdcephfs_hldy2/share_305110755/hunyuan/chenhaoz/logs/wandb; mkdir -p "$WANDB_DIR"
