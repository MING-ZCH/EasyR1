...
python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path=/mnt/shared-storage-user/zhangchenhao/work/EasyR1-latest/save/StepCount-7B-SFT-30k_v27b_easy_data_${ADV_ESTIMATOR}_$(date +%Y%m%d_%H%M) \
