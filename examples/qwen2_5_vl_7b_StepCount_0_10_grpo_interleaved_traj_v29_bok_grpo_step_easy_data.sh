...
if [[ "${V29_DRY_RUN:-0}" == "1" ]]; then
    ...
    echo "[DryRun] train_data=${STEPCOUNT_TRAIN_DATA:-/mnt/shared-storage-user/zhangchenhao/work/StepcountModel/dataset/StepCountQA-RL-Traj_0_10}"
...
python3 -m verl.trainer.main \
    ...
    trainer.save_checkpoint_path=/mnt/shared-storage-user/zhangchenhao/work/EasyR1-latest/save/StepCount-7B-SFT-30k_v29_bok_grpo_step_easy_${ADV_ESTIMATOR}_$(date +%Y%m%d_%H%M) \
