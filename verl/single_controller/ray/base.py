        ...
        for pg_idx, pg in enumerate(sort_placement_group_by_node_ip(pgs)):
            ...
            for local_rank in range(local_world_size):
                ...
                env_vars = {
                    ...
                    "WG_BACKEND": "ray",
                    # Keep LOCAL_RANK unset here: Ray narrows CUDA_VISIBLE_DEVICES
                    # per actor, so vLLM should see process-local cuda:0.
                ...
                # workers fail torch.cuda init with "Found no NVIDIA driver".
                for key in (
                    "LD_LIBRARY_PATH",
                    "PYTHONUNBUFFERED",
